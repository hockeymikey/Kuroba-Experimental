...
sealed class WatcherScreen(
  ...
  sealed class ThreadDownloaderGroup(
    ...
    object ThreadDownloaderMediaDownloadDelay : ThreadDownloaderGroup("thread_downloader_media_download_delay")
    object ExtractAllMetadata : ThreadDownloaderGroup("extract_all_metadata")
